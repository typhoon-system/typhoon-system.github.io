...
myContract.getPastEvents(
    'Transfer', // 过滤事件参数，这里获取全部事件
    {
     // address: '0x8db1e1a6548f1dedbdF4346c5Efbb56e88Ee295e',
      fromBlock: '0', // 起始块20734876 20730649
    ...
    (err, events) => { 
      console.log('events bu cun zai 1') 
        ...
        nftEvent=events;
        // console.log(nftEvent[0].blockNumber)
        // console.log(nftEvent[1].blockNumber) 
        // console.log(nftEvent[1].id)
        // console.log(nftEvent[1].logIndex)
        // console.log(nftEvent[1].returnValues)

        // console.log(nftEvent[1].returnValues[0])
        // console.log(nftEvent[1].returnValues[1])
        // console.log(nftEvent[1].returnValues[2])

        // var blockNumber=nftEvent[1].blockNumber;
        // var logIndex=nftEvent[1].id;
        // var ToAddress=nftEvent[1].returnValues[1];
        // var Token_nftId=nftEvent[1].returnValues[2];
...
//     console.log(found);
  ...
  for (var log in nftEvent) {
    console.log('hello')
    console.log(log[0].blockNumber) 
    console.log(log[0].id) 
  }

  // for(var i = 0; i < nftEvent.len; i++) {
  //   console.log(nftEvent[1].blockNumber) 
...
//0x14395B73E7b49560523Bcd2E4Ad3A3BdA9E2feDd/
var myContract2 = new web3.eth.Contract(JSON.parse(data),'0x14395B73E7b49560523Bcd2E4Ad3A3BdA9E2feDd');

myContract.methods.getblockNumbers().send().then(console.log)
